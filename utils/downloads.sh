...
download_ss_file(){
    ...
    if [[ ${SS_VERSION} = "ss-libev" ]]; then
        ...
        shadowsocks_rust_file="shadowsocks-v${rust_ver}.aarch64-unknown-linux-gnu"
        shadowsocks_rust_url="https://github.com/shadowsocks/shadowsocks-rust/releases/download/v${rust_ver}/shadowsocks-v${rust_ver}.aarch64-unknown-linux-gnu.tar.xz"
...
download_plugins_file(){
    ...
    if [[ "${plugin_num}" == "1" ]]; then        
        ...
        v2ray_plugin_file="v2ray-plugin-linux-arm64-v${v2ray_plugin_ver}"
        v2ray_plugin_url="https://github.com/teddysun/v2ray-plugin/releases/download/v${v2ray_plugin_ver}/v2ray-plugin-linux-arm64-v${v2ray_plugin_ver}.tar.gz"
